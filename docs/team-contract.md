...
### 1. Lead Developer (Steven)
- Define system architecture (ERD, UML, Use Case, etc.)
...
- Primary communication will be conducted via **WhatsApp**

---

## Response Time Rules
- Response time is **flexible**, but members are expected to stay reasonably responsive and communicative
...
- If issues cannot be resolved within the team, escalate by **contacting the assistant**

---

## Agreement
By participating in this project, all team members agree to follow this contract and collaborate responsibly.
